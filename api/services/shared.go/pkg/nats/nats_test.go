...
func TestNatsModule(t *testing.T) {
	t.Run("Test Connect Nats", TestConnectNats)
	t.Run("Test Connect Nats Should Nats", TestConnectNatsShouldNats)
	t.Run("Test Connect JS Should JetStream", TestConnectJSShouldJetStream)
	t.Run("Test Init Default Should Nats And JetStream", TestInitDefaultShouldNatsAndJetStream)
	t.Run("Test Conn AddStream", TestConn_AddStream)
	t.Run("Test Conn UpdateStream", TestConn_UpdateStream)
}
